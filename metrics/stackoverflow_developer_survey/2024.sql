-- DuckDB: Calculates web framework popularity, loved/wanted/dreaded metrics from Stack Overflow 2024 survey data.
create table results_2024 as WITH frameworks AS (
    SELECT UNNEST([
        'Angular',
        'React',
        'Next',
...
SELECT
    ...
    Current_Popularity / 45161 as Current_Popularity_Percent,
    coalesce(d.Popularity, 0) AS Desired_Popularity,
    Desired_Popularity / 45161 as Desired_Popularity_Percent,
    ...
    Wanted / 45161 as Wanted_Percent,
