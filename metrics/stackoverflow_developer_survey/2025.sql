-- DuckDB: Calculates web framework popularity, loved/wanted/dreaded metrics from Stack Overflow 2025 survey data.
create table results_2025 as WITH frameworks AS (
    SELECT UNNEST([
        'Angular',
        'React',
        'Next',
...
SELECT
    ...
    Current_Popularity / 22970 as Current_Popularity_Percent,
    coalesce(d.Popularity, 0) AS Desired_Popularity,
    Desired_Popularity / 22970 as Desired_Popularity_Percent,
    ...
    Wanted / 22970 as Wanted_Percent,
