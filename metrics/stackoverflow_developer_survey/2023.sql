-- DuckDB: Calculates web framework popularity, loved/wanted/dreaded metrics from Stack Overflow 2023 survey data.
create table results_2023 as WITH frameworks AS (
    SELECT UNNEST([
        'Angular',
        'React',
        'Next',
...
SELECT
    ...
    Current_Popularity / 66938 as Current_Popularity_Percent,
    coalesce(d.Popularity, 0) AS Desired_Popularity,
    Desired_Popularity / 66938 as Desired_Popularity_Percent,
    ...
    Wanted / 66938 as Wanted_Percent,
