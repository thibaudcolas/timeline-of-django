-- DuckDB: Calculates web framework popularity, loved/wanted/dreaded metrics from Stack Overflow 2019 survey data.
create table results_2019 as WITH frameworks AS (
    SELECT UNNEST([
        'Angular',
        'React',
        'Next',
...
SELECT
    ...
    Current_Popularity / 65022 as Current_Popularity_Percent,
    coalesce(d.Popularity, 0) AS Desired_Popularity,
    Desired_Popularity / 65022 as Desired_Popularity_Percent,
    ...
    Wanted / 65022 as Wanted_Percent,
